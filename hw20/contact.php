		...
		if (isset($_POST['submit'])){
			if($_POST['submit'] == "submit"){
				...
				if(count($errStatus)>0){
					...
					redirect("https://ec2-3-141-197-204.us-east-2.compute.amazonaws.com/hw19/index.php?page=contact&$errString");
				}
				...
				redirect("https://ec2-3-141-197-204.us-east-2.compute.amazonaws.com/hw19/index.php?page=contact&msg=success");
				/*
