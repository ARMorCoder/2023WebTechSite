		...
		if (isset($_POST['submit'])){
			if($_POST['submit'] == "submit"){
				...
				if(count($errStatus)>0){
					...
					redirect("https://ec2-3-141-197-204.us-east-2.compute.amazonaws.com/hw18/index.php?page=contact&$errString");
				}
				...
				$sql="Insert into `contact_info` (`first_name`,`last_name`,`phone_number`, `email`,`comment`) values ('$fnameClean', '$lnameClean','$phoneNumberClean', '$emailClean','$commentClean')";
				
				$dblink->query($sql) or 
					die("<p>Something went wrong with: $sql<br>".$dblink->error."</p>");
				
				redirect("https://ec2-3-141-197-204.us-east-2.compute.amazonaws.com/hw18/index.php?page=contact&msg=success");
				/*
